...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'myapp/static'),  # Ruta a tu carpeta de archivos estáticos dentro de la app
]

# Directorio donde se recopilarán todos los archivos estáticos cuando ejecutes collectstatic
